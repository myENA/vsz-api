...
func (u *Users) ScgUserDeleteScgUserDelete1(ctx context.Context, requestBody *ScgUserDeleteScgUserDelete1Request) (*http.Response, []byte, error) {
...
// - error: Error seen or nil if none
func (u *Users) ScgUserAddScgUserPost(ctx context.Context, requestBody *ScgUserAddScgUserPostRequest) (*http.Response, *ScgUserAddScgUserPost200Response, error) {
...
// - error: Error seen or nil if none
func (u *Users) ScgUserQueryScgUsersPost(ctx context.Context, requestBody *ScgUserQueryScgUsersPostRequest) (*http.Response, *ScgUserQueryScgUsersPost200Response, error) {
...
// - error: Error seen or nil if none
func (u *Users) ScgUserDeleteScgUserDelete(ctx context.Context, userId string) (*http.Response, *ScgUserDeleteScgUserDelete200Response, error) {
	var err error
...
// - error: Error seen or nil if none
func (u *Users) ScgUserGetScgUserGet(ctx context.Context, userId string) (*http.Response, *ScgUserGetScgUserGet200Response, error) {
	var err error
...
// - error: Error seen or nil if none
func (u *Users) ScgUserUpdateScgUserPatch(ctx context.Context, userId string, requestBody *ScgUserUpdateScgUserPatchRequest) (*http.Response, *ScgUserUpdateScgUserPatch200Response, error) {
	var err error
